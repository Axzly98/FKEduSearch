...
//link to query
$sql = "INSERT INTO complaint (user_ID, admin_ID,expert_ID, complaintStatus_ID, complaint_Type, complaint_Desc, complaint_Date, complaint_Time) VALUES ('$iduser','$idadmin','$idexpert','$statusid', '$type', '$desc','$date', '$time')";
